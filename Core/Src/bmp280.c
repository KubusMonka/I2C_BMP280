...
// Read 8 bits from BMP280 (Register)
...
// Write 8 bits to BMP280 (Register)
...
// Read 16 bits from BMP280 (Register)
...
// Read 24 bits from BMP280 (Register)
...
int32_t BMP280_ReadTemperatureRaw(BMP280_t *bmp)
{
	...
	Tmp >>= 4; // Move 4 left (storing Datasheet)
...
uint8_t BMP280_ReadPressureAndTemperature(BMP280_t *bmp, float *Pressure, float *Temperature)
{
	...
	*Pressure = (float)(p/100.0);  // Convert Pa to hPa
